...
export const platforms: Platform[] = [
  { id: "youtube", name: "YouTube", icon: "▶", group: "Video", status: "ready", tools: ["Title & SEO", "Description", "Tags & keywords", "Long-form script", "Shorts hooks", "Watch-time planner", "Subscriber growth planner", "Content calendar", "Thumbnail briefs", "Analytics planner"] },
  ...
  { id: "whatsapp", name: "WhatsApp", icon: "◉", group: "Messaging", status: "connect", tools: ["Business message drafts", "Broadcast copy", "Catalog copy", "CTA generator"] },
