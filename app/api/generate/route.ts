    ...
    try {
      if (!process.env.OPENAI_API_KEY) {
        ...
        return NextResponse.json({
          error: refund.ok ? "Live AI generation is not configured yet. Your credit has been returned." : "Live AI generation is not configured yet. Please try again later.",
