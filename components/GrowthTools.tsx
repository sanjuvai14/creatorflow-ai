...
type Props={tool:string;platform?:string};
const num=(v:string)=>Math.max(0,Number(v)||0);
export default function GrowthTools({tool,platform=""}:Props){
